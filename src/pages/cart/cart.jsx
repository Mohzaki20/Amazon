      ...
      <div className="row shop-cart p-3 ">
        <div className="col-12 col-lg-9  ">
                ...
                return (
                  <div className="row py-2 contant" key={prd.id}>
                    <div className="col-12 col-sm-3 col-md-2 ">
                      <img src={prd.thumbnail} alt="" className="img-fluid" />
                    </div>
                    <div className="col-12 col-sm-9 col-md-8">
                      ...
                      <p className="delivert my-2">
                        {t("EligibleforFREEdelivery")}
                      </p>
                      {prd.color !== undefined && (
                        <p>
                          <span className="fw-bold">color</span> : {prd.color}
                        </p>
                      )}
          ...
          <div className="text my-3">
            <p>{t("Thepriceandavailability")}</p>
            <p>{t("Doyouhaveagift")}</p>
          </div>
        </div>
          ...
          {product.length > 0 && (
            <div className="features p-3 mb-3">
              <div className="main-color">
                ...
                <span>{t("Yourorderqualifies")}</span>
              </div>
              <h5 className="">
                {t("Subtotal")} ({totalItem}
                {t("items")} ):
                <span className="">
                  {t("EGP")} {totalPrice}.00
                </span>{" "}
          ...
          <div className="best-sales  p-3 d-none d-lg-block">
            ...
            <div className="row contant">
              ...
              <div className="col-8 p-0">
                <p className="main-color fw-bold">{t("SamsungGalaxy")}</p>
                <div className="rate">
            ...
            <div className="row contant mt-2">
              ...
              <div className="col-8 p-0">
                <p className="main-color fw-bold">{t("G2000GamingHeadset")}</p>
                <div className="rate">
                  <div className="iconstar">
                    <i className="fa-solid fa-star "></i>
                    <i className="fa-solid fa-star"></i>
            ...
            <div className="row contant mt-2">
              ...
              <div className="col-8 p-0">
                <p className="main-color fw-bold">{t("NokiaC10")}</p>
                <div className="rate">
                  <div className="iconstar">
                    <i className="fa-solid fa-star "></i>
                    <i className="fa-solid fa-star"></i>
